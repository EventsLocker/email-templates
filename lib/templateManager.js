...
module.exports = {
  ...
  render: function(options, cb) {
    ...
    console.log('templateManager::render options', options.filename);
    console.log('templateManager::render locals', locals.filename);
    locals.filename = options.filename;
    locals.engine = path.extname(locals.filename || options.filename);
