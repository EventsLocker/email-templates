...
var EmailTemplate = function(templateDirectory, defaults, done) {
  ...
  //console.log('email-templates::EmailTemplate templateDirectory', templateDirectory);
  ...
  this.render = function(locals, templatePath, html, text, stylesheet, bufferType, callback) {
    //console.log('email-templates::render templatePath', templatePath);
    ...
    //console.log('email-templates::render locals.templatePath', locals.templatePath);
    ...
    //console.log('email-templates::render htmlOpts', htmlOpts);
    //console.log('email-templates::render textOpts', textOpts);
    //console.log('email-templates::render cssOpts', cssOpts);
  ...
  fs.stat(templateDirectory, function(err, stats) {
    ...
    //console.log('email-templates::fs.stat stats.isDirectory()', stats.isDirectory());
    ...
    if (!stats.isDirectory())
      ...
      //console.log('email-templates::fs.stat done templateName', templateName);
      var scopeInfo = {
        'templatePath': '',
        'stylesheet': '',
        'text': '',
      ...
      var batchCheck = function() {
        ...
        if (isBuffer) {
          //console.log('email-templates::batchCheck templatePath', templatePath);
      ...
      //console.log('email-templates:: templatePath', templatePath);

      // Ensure the `templateName` is a valid directory path
      fs.stat(templatePath, function(err, stats) {
        //console.log('email-templates:: templatePath / fs.state err', err);
